...
from .cnic_data_extraction_view import ExtractOCRView
from .emirates_data_view import EmiratesDataView
...
urlpatterns = [
    ...
    path('tools/use/cnic-data-extraction/', ExtractOCRView.as_view(), name='cnic-data-extraction'),
